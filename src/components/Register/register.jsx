...
const Register = () => {
  ...
  const cardStyle = {
    ...
    color: "#0D3B66",
    borderRadius: 2,
    padding: isMobile ? 1 : 2, // Reduced padding for smaller screens
    boxShadow: "0px 6px 15px rgba(0, 0, 0, 0.2)",
    transition: "transform 0.3s ease, box-shadow 0.3s ease",
    maxWidth: isMobile ? 300 : 350, // Responsive width
    width: "100%",
    minHeight: isMobile ? 300 : 350, // Decreased height
    display: "flex",
  ...
  return (
    <Box
      sx={{
        ...
        textAlign: "center",
        minHeight: "100vh",
        padding: isMobile ? "30px 10px" : "50px 20px", // Responsive padding
    ...
    >
      ...
      <Box sx={{ mb: isMobile ? 2 : 4 }}>
        <Typography
          variant="h2"
          sx={{
            fontSize: isMobile ? "2em" : "2.8em", // Responsive font size
            fontWeight: "bold",
            color: "#FFFFFF",
            mb: isMobile ? 1 : 2,
          }}
        ...
        <Typography
          variant="body1"
          sx={{
            fontSize: isMobile ? "1em" : "1.2em", // Responsive font size
            color: "#E0E0E0",
            mb: isMobile ? 0.5 : 1,
          }}
        >
      ...
      <Grid
        container
        spacing={isMobile ? 4 : isTablet ? 6 : 7} // Responsive spacing
            ...
            <Card sx={cardStyle}>
              <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                <Typography
                  variant="h5"
                  sx={{
                    fontSize: isMobile ? "1.4em" : "1.8em", // Responsive font size
                    color: "#0056b3",
                ...
                <Stack spacing={isMobile ? 0.5 : 1} sx={{ mb: isMobile ? 1 : 2, flexGrow: 1 }}>
                  {item.features.map((feature, idx) => (
                    <Typography
                      key={idx}
                      variant="body2"
                      sx={{ fontSize: isMobile ? "0.8em" : "1em", color: "#3C4858" }}
                    >
                      {feature}
                    </Typography>
                  ))}
                ...
                <Typography
                  variant="h4"
                  sx={{
                    fontSize: isMobile ? "1.4em" : "1.6em", // Responsive font size
                    color: "#FF5A5F",
                    fontWeight: "bold",
                    mb: isMobile ? 1 : 2,
                  }}
