...
const Events = () => {
  ...
  return (
    <div>
      <div className="useventOverview">
        <div className="useventOverlayText">
            <h1>4th Global Women Power Summit on the Dynamics of Leadership</h1>
            <div className="useventDetails">
            <div className="useventDate">
                <FaCalendarAlt className="usicon" />
                <span>October 15-16, 2026</span>
            </div>
            <div className="useventLocation">
                <FaMapMarkerAlt className="usicon" />
                <span>NewYork, USA</span>
            </div>
            </div>
            <div className="usbuttonGroup">
            <button 
            className="usevent-button" 
            // onClick={handleBrochureDownload}
          >
            Brochure
          </button>
            <button className="useventButton">Abstract</button>
            </div>
        </div>

        <div className="uscountdownContainer">
            <div className="uscountdownTimer">
            <div className="ustimeBox">
      ...
      <div className="usnewconference-overview">
        <div className="usnewimage-overview">
          <img
      ...
      <div className="usconference-Topics">
        <h1>Sessions/Topics</h1>
        <div className="usnewTopics-card-container">
          <div className="usnewTopics-card">
          ...
          <div className="usnewconference-card">
        ...
        <div className="usnew-venue">
          <h2>Venue</h2>
          <p>NewYork, USA</p>
        </div>
      </div>
      
      <div className="usnew-agenda-section">
        <h2>Scientific Agenda</h2>
        <div className="usconferenceday-buttons">
        ...
        <table className="usconference-section-table">
          <thead>
            <tr>
              <th>Time</th>
              <th>Speaker</th>
      ...
      <section className="usregistration-carai">
        <div className="usintro-carai">
          <h1>Register Now!</h1>
          <p>
        ...
        <div className="usregistration-card-carai">
          <div className="usregistration-caraicard">
